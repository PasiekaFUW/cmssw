...
#prefixPath = '/scratch_cmsse/akalinow/CMS/Data/Neutrino_gun/NeutrinoGun_PU200_ForRateEstimation/'
...
process.simOmtfPhase2DigisNN.tf_neuralNetworkFile = cms.string("/home/akalinow/scratch/CMS/OMTF/PhaseII/omtf_nn_py/omtf_nn/training/2024_Jul_04_16_28_25_classic_128_64_32_1/")

process.omtfPath = cms.Path(process.esProd*process.simOmtfPhase2Digis*process.simOmtfPhase2DigisNN*process.simOmtfPhase2DigisLUT)
############################################
####OMTF Analyzer
process.load('omtfTree_GMT_Phase2_cfi')
...
# Schedule definition
# reprocess TT, Phase2GMT, DT, OMTF
process.schedule = cms.Schedule(process.DTPhase2DigisPath,process.GMTPhase2Path,process.omtfPath,process.muAnalyzerPath,process.endjob_step)
# reprocess DT, OMTF
#process.schedule = cms.Schedule(process.DTPhase2DigisPath,process.omtfPath,process.muAnalyzerPath,process.endjob_step)
# reprocess OMTF
#process.schedule = cms.Schedule(process.omtfPath,process.muAnalyzerPath,process.endjob_step)
# read all trigger primitives from EDM file
